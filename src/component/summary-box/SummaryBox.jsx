    ...
    <Box>
      <div className="summary-box">
        <div className="summary-box__info">
          ...
          <div className="summary-box__info__values">{item.value}</div>
        </div>
        <div className="summary-box__chart">
            ...
            <CircularProgressbarWithChildren
                ...
                styles={
                    buildStyles({
                        pathColor: item.percent < 60 ? colors.red : colors.purple,
        ...
        <Box purple fullheight>
            <div className="summary-box-special">
                ...
                <div className="summary-box-special__chart">
                    {/* <Line options={chartOption} data={chartData} width={`250px`}/> */}
